...
CREATE TABLE IF NOT EXISTS hivemind_app.hive_posts (
    ...
    total_payout_value VARCHAR(30) NOT NULL DEFAULT '0.000 {{HBD_SYMBOL}}',
    ...
    curator_payout_value VARCHAR(30) NOT NULL DEFAULT '0.000 {{HBD_SYMBOL}}',
    max_accepted_payout VARCHAR(30) NOT NULL DEFAULT '1000000.000 {{HBD_SYMBOL}}',
